...
let ticketOne = new Ticket(['spaghetti', 'breadsticks'], '5:00 pm', 46)
let ticketTwo = new Ticket(['chicken', 'breadsticks'], '5:15 pm', 47)

ticketOne.updateStatus('ready')
console.log('The order for customer', ticketOne.customerId, 'is now', ticketOne.status)
ticketTwo.updateStatus('ready')
console.log('The order for customer', ticketTwo.customerId, 'is now', ticketTwo.status)
...
console.log('The order for customer', firstTicket.customerId, 'is now', firstTicket.status)